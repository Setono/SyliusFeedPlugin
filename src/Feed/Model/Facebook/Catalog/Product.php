...
final class Product
{
    ...
    private ?string $facebookProductCategory = null;
    ...
    private ?int $quantityToSellOnFacebook = null;
     ...
     * @return string|null
     */
    public function getFacebookProductCategory(): ?string
    {
        return $this->facebookProductCategory;
    }

    /**
     * @param string|null $facebookProductCategory
     */
    public function setFacebookProductCategory(?string $facebookProductCategory): void
    {
     ...
     * @return int|null
     */
    public function getQuantityToSellOnFacebook(): ?int
    {
        return $this->quantityToSellOnFacebook;
    }

    /**
     * @param int|null $quantityToSellOnFacebook
     */
    public function setQuantityToSellOnFacebook(?int $quantityToSellOnFacebook): void
    {
        $this->quantityToSellOnFacebook = $quantityToSellOnFacebook;
    }
