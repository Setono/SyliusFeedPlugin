...
/**
 * The translated taxon name for the context locale (§8.4).
 */
final class TaxonNameResolver implements ValueResolverInterface
{
    ...
    {
        return 'setono_sylius_feed.value_resolver.name';
    }
    ...
    public function resolve(object $entity, FeedContext $context): mixed
    {
        ...
        return $entity->getTranslation($locale)->getName();
    }
}
