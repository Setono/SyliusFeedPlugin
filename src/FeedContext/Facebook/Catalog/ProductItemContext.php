...
namespace Setono\SyliusFeedPlugin\FeedContext\Facebook\Catalog;

use InvalidArgumentException;
use Liip\ImagineBundle\Imagine\Cache\CacheManager;
use Setono\SyliusFeedPlugin\Feed\Model\Facebook\Catalog\Availability;
use Setono\SyliusFeedPlugin\Feed\Model\Facebook\Catalog\Condition;
use Setono\SyliusFeedPlugin\Feed\Model\Facebook\Catalog\Price;
use Setono\SyliusFeedPlugin\Feed\Model\Facebook\Catalog\Product;
...
class ProductItemContext implements ItemContextInterface
{
    ...
    public function getContextList(object $product, ChannelInterface $channel, LocaleInterface $locale): ContextListInterface
    {
        ...
        foreach ($product->getVariants() as $variant) {
            ...
            $data->setQuantityToSellOnFacebook($variant->getOnHand());
